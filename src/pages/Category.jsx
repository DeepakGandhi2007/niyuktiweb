...
export default function Categories() {
  ...
  const GET_URL = `${API_BASE}/api/category/get-categories`;
  const ADD_URL = `${API_BASE}/api/category/add-category`;
  const DELETE_URL = `${API_BASE}/api/category/delete-category`;
  const UPDATE_URL = `${API_BASE}/api/category/update-category`;
